...
func (r *RabbitMQ) setUpConsumers() error {
	msgs, err := r.dbCh.Consume(r.dbqueue, "bmp-db", false, false, false, false, nil)
	if err != nil {
		return err
	}
	r.dbMsgs = msgs

	msgs, err = r.webhookCh.Consume(r.webhookQueue, "bmp-webhook", false, false, false, false, nil)
	if err != nil {
		return err
	}
	r.webhookMsgs = msgs
